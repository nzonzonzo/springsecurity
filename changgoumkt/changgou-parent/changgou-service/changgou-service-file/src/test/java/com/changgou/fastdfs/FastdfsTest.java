...
public class FastdfsTest {
    ...
    public void upload() throws Exception {
        ...
        //2.加载配置文件 建立链接
        ClientGlobal.init("C:\\Users\\admin\\IdeaProjects\\98\\changgou98\\changgou-parent\\changgou-changgou\\changgou-changgou-file\\src\\main\\resources\\fdfs_client.conf");
        //3.创建trackerClient
        ...
        //参数1 指定要上传图片的本地的图片的绝对路径 或者 给文件的字节数组
        //参数2 指定要上传图片的图片的扩展名（jpg/png）不要带点
        //参数3 指定元数据 指的是 图片的高度 日期，像素......    可以不给，
        String[] jpgs = storageClient.upload_file("C:\\Users\\admin\\Pictures\\Saved Pictures\\5a38e39b2975e837.jpg", "jpg", null);
        for (String jpg : jpgs) {
    ...
    public void download() throws Exception {
        ...
        //参数1 指定要下载的组名
        //参数2 指定要下载的远程文件路径
        byte[] group1s = storageClient.download_file("group1", "M00/00/00/wKjThF9p3xKAaneLAAX7uZ3HmDk268.jpg");
        //写入磁盘
    ...
    public void delete() throws Exception {
        ...
        //6.创建stroageClient --->提供了很多的操作图片的API的代码（上传图片，下载 ，删除）
        StorageClient storageClient = new StorageClient(trackerServer, null);
        int group1 = storageClient.delete_file("group1", "M00/00/00/wKjThF9p3xKAaneLAAX7uZ3HmDk268.jpg");
        if (group1 == 0) {
